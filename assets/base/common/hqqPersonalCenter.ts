...
import hqqDatePicker from "./hqqDatePicker";
    ...
    */
    ...
    onMenuClick(toggle, customEventData) {
        ...
        if (Number(customEventData) === 1) {
            ...
            cc.find("personalcenter/btncontainer/tzjl/checkmark/basicInfo_bg/tabScrollView/view/tabToggleContainer").children[0].getComponent(cc.Toggle).setIsCheckedWithoutNotify(true);
            ...
            cc.find("personalcenter/btncontainer/ylgk/checkmark/basicInfo_bg/tabScrollView/view/tabToggleContainer").children[0].getComponent(cc.Toggle).setIsCheckedWithoutNotify(true);
