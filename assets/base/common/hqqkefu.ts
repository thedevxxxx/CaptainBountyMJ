...
export default class hqqkefu extends cc.Component {
    ...
    start () {
        ...
        if( cc.isValid(this.kefuweb) ){
            let url = hqq.app.versionJson.live_service.url1;
            if(hqq.app.versionJson[hqq.app.pinpai]){
                if(hqq.app.versionJson[hqq.app.pinpai].live_service){
                    if(hqq.app.versionJson[hqq.app.pinpai].live_service.url1){
                        url = hqq.app.versionJson[hqq.app.pinpai].live_service.url1;
                    }
                }
            }
            this.kefuweb.url = url;
        ...
        let zxkf = cc.find("Canvas/kefulayer/btncontainer/zxkf")
        if( cc.isValid(zxkf) ){
        ...
        let zxkfd_menu = cc.find("Canvas/kefulayer/btncontainer/zxkf/d_menu")
        ...
        let zxkfunselect = cc.find("Canvas/kefulayer/btncontainer/zxkf/d_menu/Background");
        ...
        let zxkfselect = cc.find("Canvas/kefulayer/btncontainer/zxkf/checkmark/dating_menu_btn_selected");
        ...
        let contact_CS_bg = cc.find("Canvas/kefulayer/btncontainer/zxkf/checkmark/contact_CS_bg");
        ...
        let cjwtcontent = cc.find("Canvas/kefulayer/btncontainer/zxkf/checkmark/cjwt");
        ...
        let menu_bottom_particle = cc.find("Canvas/kefulayer/menu_bottom_particle")
        ...
        if( hqq.app.pinpai == "ninetwo"  || hqq.app.pinpai == "ninethree"){
            hqq.setSprite( cc.find("Canvas/kefulayer/exitbtn"),{Res:hqq["hall_"+hqq.app.pinpai],path:"language/" + hqq.language + "/ninetwo/img/fanhui"});
            hqq.setSprite( cc.find("Canvas/kefulayer/title"),{Res:hqq["hall_"+hqq.app.pinpai],path:"language/" + hqq.language + "/ninetwo/img/title_kf"});
        }
    }
    onClose(){
