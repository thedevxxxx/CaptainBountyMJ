...
@ccclass('PayUsdtDh1')
export default class PayUsdtDh1 extends Component {
    @property(Label)
    goldLabel: Label | null = null; //余额
    @property(Label)
    usdt_goldLabel: Label | null = null; //转换usdt余额
    @property(Label)
    conf_val_label: Label | null = null; 
    @property(Label)
    amountLabel: Label | null = null; //兑换金额
    @property(Label)
    dhArea: Label | null = null; //兑换范围
    @property(Label)
    walletAddressLabel: Label | null = null; 
    @property(Label)
    chanTypeLabel: Label | null = null;
    @property(Node)
    bindBtn: Node | null = null;
    @property(Node)
