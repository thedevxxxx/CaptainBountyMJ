...
@ccclass('PayRechargeHistory1')
export default class PayRechargeHistory1 extends Component {
    @property(Prefab)
    ...
    onLoad () {
        ...
        this.ToggleContainer.parent.parent.getComponent(cc.UITransform).height = Number(this.ToggleContainer.parent.parent.getComponent(cc.UITransform).height)-Number(this.ToggleContainer.parent.parent.getComponent(cc.UITransform).height)*(scalex-1)
        ...
        this.app.ajax('GET',url,'',(response)=>{
            ...
            if(response.status == 0){
                ...
                for(var i = 0; i < listArr.length; i++){
                    ...
                    node.getComponent('PayRechargeHistoryListItem1').init({
                        amount : data.amount,
    ...
    public addNavToggle(){
        ...
        for(let i:number = 0; i< arr.length; i++){
            ...
            node.getComponent('PayRechargeHistoryToggle1').init({
                text : arr[i],
                index : i,
                parentComponet:this
            })
