...
@ccclass('PayBankAccountAlert1')
export default class PayBankAccountAlert1 extends Component {
    @property(Prefab)
    BankSelectItem: Prefab | null = null;
    @property(EditBox)
    accountInput: EditBox | null = null;
    @property(EditBox)
    nameInput: EditBox | null = null;
    @property(EditBox)
    bankNameInput: EditBox | null = null;
    @property(Label)
    selectProvinceLabel: Label | null = null;
    @property(Label)
    selectCityLabel: Label | null = null;
    @property(Label)
    selectBankLabel: Label | null = null;
    @property(Node)
    selectProvinceContent: Node | null = null;
    @property(Node)
    selectCityContent: Node | null = null;
    @property(Node)
    selectBankContent: Node | null = null;
    @property(Node)
    accountMask :Node | null = null;
    @property(Node)
    bankMask: Node | null = null;
    @property(Label)
    AqmLabel: Label | null = null; // 安全码
    ...
    addProvinceItem(){
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            node.getComponent('PayBankSelectItem1').init({
                text: results[i],
