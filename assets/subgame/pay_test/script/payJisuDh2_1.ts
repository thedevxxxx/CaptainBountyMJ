...
@ccclass('PayJisuDhTwo1')
export default class PayJisuDhTwo1 extends Component {
    @property(Label)
    ...
    deleteAmount(){
        ...
        node.getComponent("PayJisuCyjeAlertTwo1").init(this.amountLabel,this.setDepostLabel.bind(this))
