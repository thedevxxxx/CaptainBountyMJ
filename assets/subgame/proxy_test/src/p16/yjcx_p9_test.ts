...
@ccclass('yjcx_p9_test')
export class yjcx_p9_test extends Component {
    @property(Label)
    public account_name: cc.Label | null = null;
    @property(Label)
    public gr_money: cc.Label | null = null;
    @property(Label)
    public td_money: cc.Label | null = null;
    @property(Node)
    public mid: cc.Node | null = null;
    @property(Node)
    public data1: cc.Node | null = null;
    @property(Label)
    public data1_st: cc.Label | null = null;
    @property(Node)
    public data2: cc.Node | null = null;
    @property(Label)
    public data2_st: cc.Label | null = null;
    ...
    get_data(ids: any) {
        ...
        function check1() {
            return new Promise((resolve, reject) => {
                if (hqq.app.pinpai == 'test' || hqq.app.pinpai == 'tiqnai') {
    ...
    searchByDate() {
        ...
        if (this.data1_st.string != "年/月/日") {
            ...
            console.log('未选初始日期');
            hqq.eventMgr.dispatch(hqq.eventMgr.showTip, "未选初始日期...")
            return
        }
    ...
    MoveBalanceToProxy(id: any, money: any, a: any) {
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.code == 200) {
                    cc.log('佣金转账成功');
                    a()
                    hqq.eventMgr.dispatch(hqq.eventMgr.showTip, "佣金转账成功")
                }
                if (resData.code == 404) {
    ...
    SaveMoneyFlowDetail(ID: any, num: any) {
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.msg == "操作成功") {
                    ...
                    hqq.eventMgr.dispatch(hqq.eventMgr.showTip, "账户内互转成功")
                } else {
                    console.log('error resData.msg===', resData);
                    hqq.eventMgr.dispatch(hqq.eventMgr.showTip, '账户内互转失败')
                }
            }
            xhr_test.abort();
        };
