...
@ccclass('KsGzsdScriptP6Test')
export class KsGzsdScriptP6Test extends Component {
    @property(Node)
    ...
    confirm () {
        ...
        if (hqq.app.pinpai == 'fuxin' || hqq.app.pinpai == 'huaxing' || hqq.app.pinpai == 'huangshi' || hqq.app.pinpai == 'tianqi') {
        ...
        xhr_test.onreadystatechange = () => {
           if (xhr_test.readyState == 4 && xhr_test.status === 200) {
               ...
               if (resData.code == 200) {
                   ...
                   let xjfhsd_pop = this.node.parent.getChildByName('xjfhblsd_pop')
                   xjfhsd_pop.getComponent(KsxjfhsdPopP6Test).getDividendRule(child_id)
...
//                     let xjfhsd_pop = this.node.parent.getChildByName('xjfhblsd_pop')
//                     // 正常用这个
//                     xjfhsd_pop.getComponent("ksxjfhsd_pop_p6_test").getDividendRule(child_id)
