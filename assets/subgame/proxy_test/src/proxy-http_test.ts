...
import { md5jd } from "./m5/index_test"

export let commonVal = {
    account_name: "",
    token: "",
    package_id: "",
    balance: "",
    ...
    createDividendRule() {
        ...
        console.log("/proxy/user/createDividendRule请求:", sendData);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                console.log("/proxy/user/createDividendRule返回", resData);
                xhr_test.abort();
    ...
    setDividendRule() {
        ...
        console.log("/proxy/user/setDividendRule请求:", sendData);
        xhr_test.send(sendData);
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/setDividendRule返回", resData);
                xhr_test.abort();
    ...
    getDividendRule(poxy_id, a) {
        ...
        //  }
        xhr_test.open("GET", host + `/proxy/user/getDividendRule?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${poxy_id}`, true);
        xhr_test.send();
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                console.log("http 公用方法返回getDividendRule返回", resData, Database.game_tag);
    ...
    GetStatementDividendInfo(game_num, token, first_date, last_date, a) {
        ...
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        xhr_test.open("GET", host + `/proxy/user/GetStatementDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${token}&game_tag=${game_num}&first_date=${first_date}&last_date=${last_date}`, true);

        console.log('num===', game_num);
        xhr_test.send();
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status == 200) {
                ...
                console.log("p4 /proxy/user/GetStatementDividendInfo返回", resData);
                if (resData.msg) {
    ...
    GetDeficitDividendInfo(game_num, first_date, last_date, a) {
        ...
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        xhr_test.open("GET", host + `/proxy/user/GetDeficitDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=${game_num}&first_date=${first_date}&last_date=${last_date}`, true);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/GetDeficitDividendInfo返回", resData);
    ...
    GetPaymentDividendInfo(game_num, first_date, last_date, a) {
        ...
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        xhr_test.open("GET", host + `/proxy/user/GetPaymentDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=0&first_date=${first_date}&last_date=${last_date}`, true);
        console.log('p6 获取亏损分红信息');
        console.log(host + `/proxy/user/GetPaymentDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=0&first_date=${first_date}&last_date=${last_date}`);

        xhr_test.send();
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/GetPaymentDividendInfo返回", resData);
    ...
    getDividendRuleonetype(game_tag, typen, a) {
        ...
        //     - game_tag 游戏分类 可选  &game_tag=${commonVal.gametags}
        //  }
        xhr_test.open("GET", host + `/proxy/user/getDividendRule?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&type=${typen}&game_tag=${game_tag}`, true);
        xhr_test.send();
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                console.log("用方法返回getDividendRule返回 傻傻的 参数", resData, Database.yf_demand_tag, Database.yf_demand_type);
        ...
        xhr.onreadystatechange = () => {
            if (xhr.readyState == 4 && xhr.status === 200) {
                ...
                if (res.code === 200) {
                    ...
                    console.log("getalllchild9 返回内容", this.page, res);
    ...
    getProxyUserNumber(ids, a) { //得到下级团队人数
        ...
        console.log('GetProxyUserNumber', url);
        var xhr = new XMLHttpRequest();
        xhr.onreadystatechange = () => {
            if (xhr.readyState == 4 && xhr.status === 200) {
                const res = JSON.parse(xhr.responseText);
                if (res.code === 200) {
                    ...
                    console.log("GetProxyUserNumber 返回内容", res.msg);

                    if (res.msg != null) {
                        console.log(Database.page9_wjmx, '======Database.page9_wjmx');
    ...
    Center_GetBaseDividendRule(id, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}`, true);

        console.log(host + `/proxy/user/GetBaseDividendRule?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.msg == null) {
                    ...
                    } else if (hqq.app.pinpai == 'huangshi' || hqq.app.pinpai == 'juding') {
                        //默认100
                ...
                console.log('Database.page9_aumont===', Database.page9_aumont);
                a()
                xhr_test.abort();
            }
    ...
    GetBaseDividendRule(a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}`, true);
        xhr_test.send();
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/GetBaseDividendRule 测试返回", resData);
    ...
    c_GetBaseDividendRule(a) {
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/c_GetBaseDividendRule返回", resData);
    ...
    SetBaseDividendRule(ids, money, a) {
        ...
        var sendData = `account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&child_id=${ids}&income=${money}`;
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("SetBaseDividendRule返回", resData);
    ...
    GetBaseDividendInfo(first, last, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&first_date=${first}&last_date=${last}&token=${commonVal.token}`, true);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.code == 404) {
                    ...
                    console.log(txt);
                    // hqq.eventMgr.dispatch(hqq.eventMgr.showTip, txt)//发起提示
                }
                console.log("p10       /proxy/user/GetBaseDividendInfo", resData);
                if (resData.msg) {
    ...
    GetGameUserInductions(ids, ic, ends, end_time, a) {
        ...
        var xhr_test = new XMLHttpRequest();
        if (hqq.app.pinpai == 'xinlong') {
            xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1]`, true);
        } else {
            xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1,5]`, true);
        }
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p10   /proxy/user/GetGameUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
                    ...
                    for (let a = 0; a < data_key.length; a++) {
                        for (let i = 0; i < data_msg[data_key[a]].length; i++) {
                            if (data_msg[data_key[a]][i].base_dividend_type == 1) {
                                ...
                                zswj += parseFloat(data_msg[data_key[a]][i].bet_total) * parseFloat(data_msg[data_key[a]][i].base_dividend_discount) / 100
                            }
    ...
    p10_GetGameUserInductions(ids, end_time, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${Database.p10_num}]`, true);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                // console.log("p10 下级脚本 /proxy/user/GetGameUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
    ...
    p6sgetDividendRule() {
        ...
        //     - game_tag 游戏分类 可选
        //  }
        xhr_test.open("GET", host + `/proxy/user/getDividendRule?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=0&type=3`, true);
        xhr_test.send();

        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/getDividendRule返回   p6自己比例", resData);
                //得到数据渲染
    ...
    GetProxyUserLinkBet(start, end, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetProxyUserLinkBet?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&start_time=${start}&end_time=${end}`, true);
        xhr_test.send();

        console.log("查询7日链接", host + `/proxy/user/GetProxyUserLinkBet?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&start_time=${start}&end_time=${end}`);
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p1      /proxy/user/GetProxyUserLinkBet返回", resData);
    ...
    GetProxyUserLinkstatement(start, end, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetProxyUserLinkstatement?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&start_time=${start}&end_time=${end}`, true);
        xhr_test.send();

        console.log("查询7日链接", host + `/proxy/user/GetProxyUserLinkstatement?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&start_time=${start}&end_time=${end}`);
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p1      /proxy/user/GetProxyUserLinkstatement返回", resData);
                Database.p1_seven_info = resData.msg
    ...
    GetPaymentInfo(first_date, last_date, a) {
        ...
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        xhr_test.open("GET", host + `/proxy/user/GetPaymentInfo?id=${hqq.gameGlobal.player.account_name}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${start}&end_time=${end}`, true);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status == 200) {
                ...
                console.log("p12 /proxy/user/GetPaymentInfo返回", commonVal.p12_data);
    ...
    GetPaymentInfoDetail(date, a) {
        ...
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        xhr_test.open("GET", host + `/proxy/user/GetPaymentInfoDetail?id=${hqq.gameGlobal.player.account_name}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&date=${date}`, true);
        console.log(host + `/proxy/user/GetPaymentInfoDetail?id=${hqq.gameGlobal.player.account_name}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&date=${date}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status == 200) {
                ...
                console.log("p12 /proxy/user/GetPaymentInfoDetail?", commonVal.p12_view_data);
                a();
                xhr_test.abort();
            }
    ...
    SaveEmailDetail(ID, num) {
        ...
        let pass = md5jd.md5(ID + "e40f01afbb1b9ae3dd6747ced5bca532", '', '')
        let host = hqq.gameGlobal.pay.pay_host
        var xhr_test = new XMLHttpRequest();
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("SaveMoneyFlowDetail返回", resData);

                if (resData.msg == "操作成功") {

                    console.log('resData.msg===', resData);
    ...
    p1_SaveEmailDetail(ID, num) {
        ...
        xhr_test.open("POST", host + "/api/backend/SaveEmailDetail", true);
        xhr_test.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        var sendData = `user_id=${ID}&title=${"佣金收益"}&content=${content}&action=add&token=${tok}&center_auth=${hqq.gameGlobal.token}`;
        console.log('p1 save sendData=', sendData);

        console.log(host + "/api/backend/SaveEmailDetail  佣金领取：", sendData);
        xhr_test.send(sendData);
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
    ...
    jd_p9_GetBaseDividendRule(num, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule1?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=${num}`, true);
        xhr_test.send();
        console.log("GET", host + `/proxy/user/GetBaseDividendRule1?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=${num}`);

        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("/proxy/user/jd_GetBaseDividendRule1返回", resData);
                if (num == 1) {
                    if (resData.msg == null) {
                ...
                if (num == 2) {
                    if (resData.msg == null) {
                        ...
                        if (hqq.app.pinpai == 'test') {
                            Database.p9_cp_aumont = '80元。'
                        }

                    } else {
                        Database.p9_cp_aumont = resData.msg.income + '元.'

                    }
                    console.log('Database.p9_cp_aumont=', Database.p9_cp_aumont);
                }
                if (num == 3) {
                    if (resData.msg == null) {

                        if (hqq.app.pinpai == 'test') {
                            Database.p9_ty_aumont = '80元。'
                        }

                    } else {
                        Database.p9_ty_aumont = resData.msg.income + '元.'

                    }
                    console.log('Database.p9_ty_aumont=', Database.p9_ty_aumont);
                }
                if (num == 4) {
                    if (resData.msg == null) {

                        if (hqq.app.pinpai == 'test') {
                            Database.p9_sx_aumont = '80元。'
                        }

                    } else {
                        Database.p9_sx_aumont = resData.msg.income + '元.'

                    }
                    console.log('Database.p9_qp_aumont=', Database.p9_sx_aumont);
                }
                if (num == 5) {
                    if (!resData.msg) {
                        if (hqq.app.pinpai == 'juding') {
    ...
    JD_Center_GetBaseDividendRule(id, num, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule1?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=${num}`, true);

        console.log(host + `/proxy/user/GetBaseDividendRule1?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=${num}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.msg == null) {
                    ...
                    //默认100
                    Database.page9_aumont = '100'
                    if (num == 1 && hqq.app.pinpai == 'huaxing') {
                        Database.page9_aumont = '160'
                    }
                    if (num == 5 && hqq.app.pinpai == 'huaxing') {
                        Database.page9_aumont = '80'
                    }
                    //92 预设
                    if (num == 1 && hqq.app.pinpai == 'ninetwo') {
                        Database.page9_n2qp_aumont = '' + 100
                    }
                    if (num == 5 && hqq.app.pinpai == 'ninetwo') {
                        Database.page9_n2dz_aumont = '' + 100
                    }
                    if (num == 1 && hqq.app.pinpai == 'chaofan') {
                        Database.page9_n2qp_aumont = '' + 90
                    }
                    if (num == 5 && hqq.app.pinpai == 'chaofan') {
                        Database.page9_n2dz_aumont = '' + 90
                    }
                ...
                console.log('下级  Database.page9_aumont===', Database.page9_aumont);
                a()
                xhr_test.abort();
            }
    ...
    jd_SetBaseDividendRule(ids, money, num, a) {
        ...
        var sendData = `account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&child_id=${ids}&income=${money}&game_tag=${num}`;

        console.log(`jd_SetBaseDividendRule返回 account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&child_id=${ids}&income=${money}&game_tag=${num}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("jd_SetBaseDividendRule返回", resData);
                if (resData.status == "SUCCESS") {
    ...
    jd_GetBaseDividendInfo(first, last, num, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendInfo1?account_name=${hqq.gameGlobal.player.account_name}&first_date=${first}&last_date=${last}&token=${commonVal.token}&game_tag=${num}`, true);

        console.log("jd GET", host + `/proxy/user/GetBaseDividendInfo1?account_name=${hqq.gameGlobal.player.account_name}&first_date=${first}&last_date=${last}&token=${commonVal.token}&game_tag=${num}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                console.log("jd p10       /proxy/user/GetBaseDividendInfo1", resData);
                if (resData.msg) {
                    Database.formatData10(resData.msg);
                }
    ...
    jd_GetGameUserInductions(ids, ic, ends, end_time, nums, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${nums}]`, true);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p10   /proxy/user/GetGameUserInductionsSortByGameTag1" + nums + " 返回", resData);
                // //得到数据渲染

                let zswj = 0;

                if (resData.msg != null && resData.code != 404) {
                    let data_key = Object.keys(resData.msg)
                    let data_msg = resData.msg;
                    for (let a = 0; a < data_key.length; a++) {
                        for (let i = 0; i < data_msg[data_key[a]].length; i++) {
    ...
    p9_GetGameUserInductions(ids, end_time, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1,5]`, true);
        console.log(host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1,5]`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p9 下级脚本 /proxy/user/GetGameUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
    ...
    p9_GetProxyUserInductionsSortByGameTag(ids, end_time, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetProxyUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1,5]`, true);
        console.log(host + `/proxy/user/GetProxyUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[1,5]`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p9 下级脚本团队 /proxy/user/GetProxyUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
    ...
    hj_p9_GetGameUserInductions(ids, end_time, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${commonVal.gametags}]`, true);
        console.log(host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${commonVal.gametags}]`);
    ...
    hj_p9_GetProxyUserInductionsSortByGameTag(ids, end_time, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetProxyUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${commonVal.gametags}]`, true);
        console.log(host + `/proxy/user/GetProxyUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&ids=[${ids}]&start_time=${start}&end_time=${end}&token=${commonVal.token}&game_tags=[${commonVal.gametags}]`);
    ...
    p9_GetGameUserInductionds(ids, first, last, a) {
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p9 下级脚本个人期区间 /proxy/user/GetGameUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
    ...
    p9_GetProxyUserInductionsSortByGameTagdt(ids, first, last, a) {
        console.log('团队 first===', first, 'last===', last);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p9 下级脚本团队日期区间 /proxy/user/GetProxyUserInductionsSortByGameTag 返回", resData);
                // //得到数据渲染
    ...
    p9_GetProxyUser(id, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetProxyUser?account_name=${hqq.gameGlobal.player.account_name}&id=${id}&token=${commonVal.token}`, true);

        console.log(host + `/proxy/user/GetProxyUser?account_name=${hqq.gameGlobal.player.account_name}&id=${id}&token=${commonVal.token}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (resData.code != 404 && resData.msg) {
                    console.log(" p9_GetProxyUser返回 查询单个ID", resData);

                    Database.p9_dlsj = resData.msg
                    a();
                } else {
                    console.log(" p9_GetProxyUser返回 查询单个ID 404", resData);
    ...
    p9_getProxyUserNumber(ids, a) { //得到下级团队人数
        ...
        console.log('p9 GetProxyUserNumber', url);
        var xhr = new XMLHttpRequest();
        xhr.onreadystatechange = () => {
            if (xhr.readyState == 4 && xhr.status === 200) {
                const res = JSON.parse(xhr.responseText);
                if (res.code === 200) {
                    ...
                    console.log("p9得到下级团队人数 GetProxyUserNumber 返回内容", res);
    ...
    huaxing_getDividendRule(b) {
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p6 load 我的比例 /proxy/user/getDividendRule返回", resData);
                //得到数据渲染
    ...
    n2_today_GetBaseDividendInfo2(ns, b, tag) {
        ...
        xhr.open("GET", host + `/proxy/user/GetBaseDividendInfo2?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&first_date=${data}&last_date=${last}&game_tag=${tag}`, true);
        ...
        xhr.onreadystatechange = () => {//
            if (xhr.readyState == 4 && xhr.status === 200) {
                ...
                if (resData.msg != null) {
                    ...
                    if (ns == 'week') {
                        if (tag == 1) {
                            console.log("---------------n2 today_GetBaseDividendInfo2 本周 返回=", resData);
                        }
    ...
    n2_GetMoveBalanceToGameUserInfo(b) {
        ...
        start = Database.getUnixtimestamp0(start).toString();
        let end = Database.getNowFormatDate(0);
        end = Database.getUnixtimestamp(end).toString();
        let host = hqq.gameGlobal.proxy.proxy_host
        var xhr_test = new XMLHttpRequest();
        // PARAMS { 
        //     account_name 用户ID         
        ...
        //  }
        xhr_test.open("GET", host + `/proxy/user/GetMoveBalanceToGameUserInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${start}&end_time=${end}&id=${hqq.gameGlobal.player.account_name}`, true);
        xhr_test.send();

        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("---n2 领取记录 GetMoveBalanceToGameUserInfo  =", resData);
                //得到数据渲染
    ...
    n2_today_GetBaseDividendInfo2_p10(n, b, tag) {
        ...
        //      game_tag 游戏分类 可选1 棋牌 5电子
        // 
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendInfo2?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&first_date=${data}&last_date=${last}&game_tag=${tag}`, true);
        xhr_test.send();
        // console.log("GET", host + `/proxy/user/GetBaseDividendInfo2?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&first_date=${data}&last_date=${last}&game_tag=${tag}`);
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p10 n2 today_GetBaseDividendInfo2返回=", resData);
                //得到数据渲染
                ...
                if (resData.msg != null) {
                    ...
                    if (tag == 1) { //棋牌
                        ...
                        let c = Math.floor(Database.n2_zsyj_qp10 * 100) / 100
                        if (c <= 0) {
                            Database.n2_zsyj_qp10 = 0
                        }
                    ...
                    if (tag == 5) { //电子
                        ...
                        let c = Math.floor(Database.n2_zsyj_dz10 * 100) / 100
                        if (c <= 0) {
                            Database.n2_zsyj_dz10 = 0
                        }
    ...
    n2_today_GetGameUserInductionsSortByGameTag_p9(n, b, id) {
        ...
        //      ids [] 传入下级ID
        xhr_test.open("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&game_tags=[1,2,3,4,5]&ids=[${id}]`, true);
        xhr_test.send();
        // console.log("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&game_tag=[1,2,3,4,5]&ids=[${id}]`)
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p9 n2 时间段内投注额 GetGameUserInductionsSortByGameTag返回=", resData);
                //得到数据渲染
    ...
    n2_today_GetProxyLinkPayInfo_p9(n, b, id) {
        ...
        //     end_time 结束时间 -   时间戳
        //      ids  传入下级ID
        xhr_test.open("GET", host + `/proxy/user/GetProxyLinkPayInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&id=${id}`, true);
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                // console.log("----p9 n2 充值额 GetProxyLinkPayInfo 返回=", resData);
                //得到数据渲染
    ...
    n2_SetBaseDividendRule(ids, money, num, a) {
        ...
        console.log(`---n2 设置规则返回 account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&child_id=${ids}&income=${money}&game_tag=${num}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("---n2_SetBaseDividendRule2返回", resData);
                if (resData.status == "SUCCESS") {
                    ...
                    if (resData.msg.indexOf('income between') == -1) {
                        hqq.eventMgr.dispatch(hqq.eventMgr.showTip, '超出设置区间, 设置失败 -1')
                    } else {
                        console.log('报错了');
                        let txt = resData.msg
                        console.log(txt);
    ...
    n2_today_GetProxyUserInductionsSortByGameTag_p9(n, b, id) {
        ...
        //      game_tag 游戏分类[1,2,3,4,5] 可选1 棋牌 5电子
        //      ids [] 传入下级ID
        xhr_test.open("GET", host + `/proxy/user/GetProxyUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&game_tags=[1,2,3,4,5]&ids=[${id}]`, true);
        xhr_test.send();
        // console.log("GET", host + `/proxy/user/GetGameUserInductionsSortByGameTag?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&game_tag=[1,2,3,4,5]&ids=[${id}]`)
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p9 n2 时间段内投注额 GetProxyUserInductionsSortByGameTag 返回=", resData);
                //得到数据渲染
    ...
    n2_GetStockDividendInfo14(n, b) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetStockDividendInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&first_date=${data}&last_date=${last}`, true);
        ...
        xhr_test.onreadystatechange = () => {
            ...
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("n2 _GetStockDividendInfo返回=", resData);
                //得到数据渲染
                //得到数据所有的key
                let c = []
    ...
    n2_GetBaseDividendInfo2_p14(n, b, tag) {
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p14 n2 today_GetBaseDividendInfo2返回=", resData);
                //得到数据渲染
    ...
    n2_GetStockBonusAccountByID_p14(b) {
        ...
        //      game_tag 游戏分类 可选1 棋牌 5电子
        // 
        xhr_test.open("GET", host + `/proxy/user/GetStockBonusAccountByID?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}`, true);
        xhr_test.send();

        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p14 n2 GetStockBonusAccountByID 返回=", resData);
                //得到数据渲染
                if (resData.msg) {
                    console.log('1');
                    if (resData.msg.id) {
    ...
    n2_p9_GetBaseDividendRule(num, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule2?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=${num}`, true);
        xhr_test.send();
        console.log("GET", host + `/proxy/user/GetBaseDividendRule1?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=${num}`);
    ...
    n2_Center_GetBaseDividendRule(id, num, a) {
        ...
        xhr_test.open("GET", host + `/proxy/user/GetBaseDividendRule2?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=${num}`, true);

        console.log(host + `/proxy/user/GetBaseDividendRule2?id=${id}&account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&game_tag=${num}`);
        ...
        xhr_test.onreadystatechange = function () {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                ...
                if (num == 1 && hqq.app.pinpai == 'ninetwo') {
                    console.log('下级 n2 电子 Database.page9_aumont===', Database.page9_n2qp_aumont);
                }
                if (num == 5 && hqq.app.pinpai == 'ninetwo') {
                    console.log('下级 n2 棋牌 Database.page9_aumont===', Database.page9_n2dz_aumont)
                }
                console.log('下级  Database.page9_aumont===', Database.page9_aumont);
                a()
                xhr_test.abort();
    ...
    huangshi_getDividendRule() {
        ...
        xhr_test.open("GET", host + `/proxy/user/getDividendRule?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&id=${hqq.gameGlobal.player.account_name}&game_tag=${commonVal.gametags}&type=1`, true);
        ...
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("p4 load 我的比例 游戏类型=", commonVal.gametags, " /proxy/user/getDividendRule返回", resData);
                //得到数据渲染
                ...
                if (resData.msg != null) {
                    ...
                    console.log(' Database.hs_p4_gz ===', Database.hs_p4_gz);
    ...
    n2_GetProxyGroupInfo_p9(n, b) {
        ...
        //     end_time 结束时间 -   时间戳
        //      ids [] 传入下级ID
        xhr_test.open("GET", host + `/proxy/user/GetProxyGroupInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&id=${hqq.gameGlobal.player.account_name}`, true);
        xhr_test.send();
        console.log("GET", host + `/proxy/user/GetProxyGroupInfo?account_name=${hqq.gameGlobal.player.account_name}&token=${commonVal.token}&start_time=${data}&end_time=${last}&id=${hqq.gameGlobal.player.account_name}`)
        xhr_test.onreadystatechange = () => {
            if (xhr_test.readyState == 4 && xhr_test.status === 200) {
                var resData = JSON.parse(xhr_test.responseText);
                console.log("----p9 n2 捞取个人 团队 数据 返回=", resData);
                //得到数据渲染
