...
@ccclass('ProxyPage17Test')
export class ProxyPage17Test extends Component {
    @property(Node)
    ...
    checkMyAgent(event: any, num: any) {
        ...
        function check() {
            return new Promise((resolve, reject) => {
                commonVal.jd_GetBaseDividendInfo(first_date_p10, last_date_p10, num, resolve)
            })
        }
        check().then(
            (value) => {
    ...
    mysz() {
        ...
        let wdbl_pop = this.node.getChildByName("page9_pop_dz");
        //实际用 
        // this.mid.active = true;
...
//                             if (Database.data10[i].zswjyj) {
//                                 data[i].zswjyj = Database.data10[i].zswjyj
//                                 console.log(' Database.data10[i].zswjyj===', Database.data10[i].zswjyj);
//                                 zswjyj += parseFloat(data[i].zswjyj)
//                             } else {
//                                 Database.data10[i].zswjyj = 0
//                                 data[i].zswjyj = 0
...
//         //let dwb = 1;
//
//         console.log('data.zswjyj===', data.zswjyj);
//         cc.find("wddwb", newItem).getComponent(cc.Label).string = Database.countCoinsShowLabel(parseFloat(data.zswjyj));
//         let btn = newItem.getChildByName("agent_btn_s2")
//         btn.active = true;
//         btn.on("touchend", () => {
