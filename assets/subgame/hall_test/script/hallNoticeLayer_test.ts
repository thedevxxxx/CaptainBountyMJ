...
export class hallNoticeLayer_test extends cc.Component {
    ...
    onLoad() {
        this.subtitle = cc.find("noticelayer/sublayer/back/titleimg").getComponent(cc.Sprite);
        this.subtime = cc.find("noticelayer/sublayer/back/txtscroll/view/content/time").getComponent(cc.Label);
        this.subtxt = cc.find("noticelayer/sublayer/back/txtscroll/view/content/txt").getComponent(cc.Label);
        this.subscroll = cc.find("noticelayer/sublayer/back/txtscroll").getComponent(cc.ScrollView);
        this.gonggaobtn = cc.find("noticelayer/btncontainer/notice").getComponent(cc.Button);
        this.emailbtn = cc.find("noticelayer/btncontainer/email").getComponent(cc.Button);
        this.deletbtn = cc.find("noticelayer/scroll/delet1")
        this.sublayer = cc.find("noticelayer/sublayer")
        this.item = cc.find("noticelayer/item");
        this.noticescroll = cc.find("noticelayer/scroll/noticescroll").getComponent(cc.ScrollView);
        this.eamilscroll = cc.find("noticelayer/scroll/emailscroll").getComponent(cc.ScrollView);
    ...
    UILoad() {
        ...
        if (hqq.app.pinpai == "fuxin") {
            ...
            hqq.addNode(back, { path: bpath + "bg", zIndex: 0, widget: { left: 0, right: cc.view.getVisibleSize().width / 2 }, anchorX: 1, type: cc.Sprite.Type.SLICED })
            hqq.addNode(back, { path: bpath + "bg", zIndex: 0, widget: { right: 0, left: cc.view.getVisibleSize().width / 2, }, anchorX: 1, scaleX: -1, type: cc.Sprite.Type.SLICED })
            ...
            hqq.addNode(back, { Res: hqq["hall_" + hqq.app.pinpai], path: hbpath + "jd_p_contain_bg", zIndex: 0, type: cc.Sprite.Type.SLICED, width: 1334 * scalex, height: 750 * scaley })
            hqq.addNode(back, { path: hpath + "jd_p_menu_bg", zIndex: 0, type: cc.Sprite.Type.SLICED, widget: { left: 0, top: 70 }, width: 300 * scalex, height: 681 * scaley })
            ...
            cc.find("noticelayer/btncontainer").getComponent(cc.Layout).affectedByScale = true;
            ...
            let d_ggtc = hqq.addNode(back, { path: bpath + "d_ggtc", zIndex: 0, width: 1007 * scalex, height: 567 * scaley, type: cc.Sprite.Type.SLICED })
            hqq.setWidget(d_ggtc, { right: 40, top: 120 })
            hqq.addNode(back, { Res: hqq["hall_" + hqq.app.pinpai], path: hbpath + "d_top", zIndex: 0, widget: { top: 0, left: 0, right: 0 } })
            ...
            hqq.addNode(back, { path: bpath + "popup_win_bg3", width: 813, height: 562, zIndex: 0 });
            let kuang = hqq.addNode(back, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "d1", width: 784, height: 382, zIndex: 0 })
            this.nodata = hqq.addNode(kuang, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "zwsj", width: 117, height: 111, zIndex: 0 })
    ...
    onClickReadAllItem() {
        ...
        for (let i = 0; i < this.noticedata.length; i++) {
            ...
            noticehistory.push(this.noticedata[i].create_time)
            if (noticehistory.length > 200) {
                noticehistory.splice(0, 150)
            }
        }
    ...
    initSubLayer(custom: any, isemail: boolean = false) {
        ...
        if (isemail) {
            ...
            hqq.addNode(subback, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_popup_inBg", zIndex: 0 });
            ...
            if (hqq.app.pinpai == "xingui") {
                ...
                let bpath = "base/fuxin/img/"
                let hlpath = "language/" + hqq.language + "/fuxin/"
                hqq.addNode(subback, { path: bpath + "tck", zIndex: 0, anchorX: 1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                hqq.addNode(subback, { path: bpath + "tck", zIndex: 0, anchorX: 1, scaleX: -1, width: 420, height: 650, type: cc.Sprite.Type.SLICED })
                ...
                hqq.addNode(subback, { path: bpath + "d_tit", y: 240, zIndex: 0 });
