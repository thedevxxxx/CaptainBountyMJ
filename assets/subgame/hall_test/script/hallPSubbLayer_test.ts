...
export class hallPSubbLayer_test extends cc.Component {
        ...
        UILoad() {
                ...
                this.exitbtn = cc.find("bigsublayer/p_close");
                let surecg = cc.find("bigsublayer/surecg");
                this.ensurebtn = surecg.getComponent(cc.Button);
                this.resetpass = cc.find("bigsublayer/resetpass");
                this.bindyinhangka = cc.find("bigsublayer/bindyinhangka");
                this.officelogin = cc.find("bigsublayer/officelogin");
                this.selectKaihushengContent = cc.find("bigsublayer/bindyinhangka/kaihushengscrorll/view/selectContent");
                this.selectKaihushiContent = cc.find("bigsublayer/bindyinhangka/kaihushiscrorll/view/selectContent");
                this.selectKaihuhangContent = cc.find("bigsublayer/bindyinhangka/yinghangnamescrorll/view/selectContent");

                this.captchaimg1 = cc.find("bigsublayer/resetpass/imgback/captchaimg").getComponent(cc.Sprite);
                hqq.setBtn(this.captchaimg1.node, { callback: "onClickCaptcha", script: this })
                this.captchaimg2 = cc.find("bigsublayer/officelogin/imgback/captchaimg").getComponent(cc.Sprite)
                ...
                hqq.editboxTipLoad(phoneeditboxnode, "enteroldpassword")
                ...
                if (hqq.app.pinpai == "fuxin") {
                        ...
                        let kaihushengscrorll = cc.find("bigsublayer/bindyinhangka/kaihushengscrorll");
                        kaihushengscrorll.setPositionEx(160, kaihushengscrorll.getPosition().y);
                        let kaihushiscrorll = cc.find("bigsublayer/bindyinhangka/kaihushiscrorll");
                        kaihushiscrorll.setPositionEx(160, kaihushiscrorll.getPosition().y);
                        let yinghangnamescrorll = cc.find("bigsublayer/bindyinhangka/yinghangnamescrorll");
                        ...
                        hqq.setSprite(cc.find("bigsublayer/resetpass/info_form"), { Res: hqq["hall_test"], path: "test/personal/registeraccount" })
                        hqq.setSprite(cc.find("bigsublayer/officelogin/info_form"), { Res: hqq["hall_test"], path: "test/personal/registeraccount" })
                }
        }
        init(subtype: any) {
                this.subtype = 0
                ...
                switch (subtype) {
                        case 1: // 重置密码
                                ...
                                if (hqq.app.pinpai == "fuxin") {
                                        ...
                                        hqq.addNode(resetpass, { path: bpath + "srk", zIndex: 0, width: 630, x: 30, y: 145, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "srk", zIndex: 0, width: 420, x: -75, y: 48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "srk", zIndex: 0, width: 420, x: -75, y: -48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "srk", zIndex: 0, width: 630, x: 30, y: -150, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "phone", zIndex: 0, x: -250, y: 145 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "aq", zIndex: 0, x: -250, y: 48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "yj", zIndex: 0, x: -250, y: -48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "lock", zIndex: 0, x: -250, y: -150 })
                                        this.btnlabel.getComponent(cc.Label).color = cc.color(255, 255, 255,255)
                                        ...
                                        info_form.active = false
                                        let resetpass = cc.find("bigsublayer/resetpass")
                                        hqq.addNode(resetpass, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: 145, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: 48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: -48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: -150, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "shoujid", zIndex: 0, x: -250, y: 145 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "fang", zIndex: 0, x: -250, y: 48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "duanxin", zIndex: 0, x: -250, y: -48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "suotou", zIndex: 0, x: -250, y: -150 })
                                        this.btnlabel.getComponent(cc.Label).color = cc.color(255, 255, 255,255)
                                        let lao = this.btnlabel.getComponent(cc.LabelOutline)
                                        lao.color = cc.color(67, 0, 0)
                                        lao.width = 2
                                        ...
                                        cc.find("bigsublayer/resetpass/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;

                                        cc.find("bigsublayer/resetpass/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;

                                        cc.find("bigsublayer/resetpass/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;

                                        cc.find("bigsublayer/resetpass/passeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/passeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/passeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        this.btnlabel.getComponent(cc.Label).color = cc.color(255, 255, 255,255)
                                        let lao = this.btnlabel.getComponent(cc.LabelOutline)
                                        lao.color = cc.color(255, 255, 255,255)
                                        this.btnlabel2.getComponent(cc.Label).color = cc.color(255, 255, 255,255)
                                        let lao2 = this.btnlabel2.getComponent(cc.LabelOutline)
                                        lao2.color = cc.color(255, 255, 255,255)
                                        ...
                                        info_form.active = false
                                        let resetpass = cc.find("bigsublayer/resetpass")
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: 145, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: 48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: -48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: -150, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "shoujid", zIndex: 0, x: -250, y: 145 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "fang", zIndex: 0, x: -250, y: 48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "duanxin", zIndex: 0, x: -250, y: -48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "suotou", zIndex: 0, x: -250, y: -150 })
                                        ...
                                        cc.find("bigsublayer/resetpass/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;
                                        cc.find("bigsublayer/resetpass/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;

                                        cc.find("bigsublayer/resetpass/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;

                                        cc.find("bigsublayer/resetpass/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;
                                        cc.find("bigsublayer/resetpass/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;

                                        cc.find("bigsublayer/resetpass/passeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/passeditbox/TEXT_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/passeditbox/TEXT_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;
                                        cc.find("bigsublayer/resetpass/passeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        cc.find("bigsublayer/resetpass/passeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).fontSize = 28;
                                        cc.find("bigsublayer/resetpass/passeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).horizontalAlign = cc.Label.HorizontalAlign.LEFT;
                                } else if (hqq.app.pinpai == "huaxing") {
                                        let bpath = "base/huaxing/img/"
                                        let hpath = "huaxing/img/"
                                        let hlpath = "language/" + hqq.language + "/huaxing/"
                                        ...
                                        info_form.active = false
                                        let resetpass = cc.find("bigsublayer/resetpass")
                                        hqq.addNode(resetpass, { path: bpath + "4", zIndex: 0, width: 630, x: 30, y: 145, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "4", zIndex: 0, width: 420, x: -75, y: 48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "4", zIndex: 0, width: 420, x: -75, y: -48, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "4", zIndex: 0, width: 630, x: 30, y: -150, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(resetpass, { path: bpath + "19", zIndex: 0, x: -250, y: 145 })
                                        hqq.addNode(resetpass, { path: bpath + "21", zIndex: 0, x: -250, y: 48 })
                                        hqq.addNode(resetpass, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "20", zIndex: 0, x: -250, y: -48 })
                                        hqq.addNode(resetpass, { path: bpath + "18", zIndex: 0, x: -250, y: -150 })
                                        ...
                                        let resetpass = cc.find("bigsublayer/resetpass")
                                        hqq.addNode(resetpass, { path: bpath + "kuangti1", zIndex: 0, width: 750, height: 350, x: 0, y: 0, type: cc.Sprite.Type.SLICED })
                                        let input1 = hqq.addNode(resetpass, { path: bpath + "yjks", zIndex: 0, width: 513 * (750 / 576), height: 36 * (450 / 273), x: 0, y: 135, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(input1, { path: bpath + "shouji", x: -310 })
                                        let input2 = hqq.addNode(resetpass, { path: bpath + "yjks", zIndex: 0, width: 290 * (750 / 576), height: 36 * (450 / 273), x: -145, y: 45, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(input2, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "34w", x: -167 })
                                        let input3 = hqq.addNode(resetpass, { path: bpath + "yjks", zIndex: 0, width: 390 * (750 / 576), height: 36 * (450 / 273), x: -82, y: -45, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(input3, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "twtrew", x: -226 })
                                        let input4 = hqq.addNode(resetpass, { path: bpath + "yjks", zIndex: 0, width: 513 * (750 / 576), height: 36 * (450 / 273), x: 0, y: -135, type: cc.Sprite.Type.SLICED })
                        ...
                        case 2: // 绑定银行卡
                                ...
                                if (hqq.app.pinpai == "fuxin") {
                                        ...
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: 188, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: 120, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: 52, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: -12, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: -82, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "srk", zIndex: 0, x: 150, y: -150, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "yhkkh", zIndex: 0, x: -225, y: 188, })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "skrxm", zIndex: 0, x: -225, y: 120, })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "kfs", zIndex: 0, x: -250, y: 52, })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "kfshi", zIndex: 0, x: -250, y: -12, })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "khyh", zIndex: 0, x: -240, y: -82, })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "khhzh", zIndex: 0, x: -225, y: -150, })
                                        ...
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "ts", zIndex: 0, y: -190, })
                                } else if (hqq.app.pinpai == "juding") {
                                        let bpath = "base/juding/img/"
                                        let hpath = "juding/img/"
                                        let hlpath = "language/" + hqq.language + "/juding/"
                                        ...
                                        let bindyinhangka = cc.find("bigsublayer/bindyinhangka")
                                        hqq.setNode(bindyinhangka, { y: -10 })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 188, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 120, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 52, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -12, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -82, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -150, width: 500, type: cc.Sprite.Type.SLICED })
                                        ...
                                        hqq.addNode(bindyinhangka, { string: "yhkkh", zIndex: 0, x: -275, y: 188, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "skrxm", zIndex: 0, x: -275, y: 120, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "kfs", zIndex: 0, x: -300, y: 52, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "kfshi", zIndex: 0, x: -300, y: -12, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "khyh", zIndex: 0, x: -290, y: -82, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "khhzh", zIndex: 0, x: -275, y: -150, fontSize: 32, color: cc.color(72, 94, 154, 255), bold: true })
                                        hqq.setSprite(this.title_bdbankcard, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "bangding3", x: -320, y: 265 })
                                        hqq.setBtn(this.kaihushengbtn, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "anniu6" })
                                        hqq.setBtn(this.kaihushibtn, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "anniu6" })
                                        hqq.setBtn(this.yinhangnamebtn, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "anniu6" })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hlpath + "ts", zIndex: 0, y: -210, })
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/kahaoeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/kahaoeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/nameediftox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/nameediftox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/zhihang/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/zhihang/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                        ...
                                        cc.find("bigsublayer/bindyinhangka/kaihusheng/kaihushenglabel").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                        cc.find("bigsublayer/bindyinhangka/kaihushi/kaihushilabel").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                        cc.find("bigsublayer/bindyinhangka/yinhangname/yinhanglabel").getComponent(cc.Label).color = cc.color(133, 147, 186, 255);
                                } else if (hqq.app.pinpai == "xingui") {
                                        this.exitbtn.x = 415
                                        this.exitbtn.y = 255
                                        let hpath = "xingui/img/"
                                        ...
                                        let bindyinhangka = cc.find("bigsublayer/bindyinhangka")
                                        hqq.setNode(bindyinhangka, { y: -10 })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 188, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 120, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: 52, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -12, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -82, width: 500, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, x: 100, y: -150, width: 500, type: cc.Sprite.Type.SLICED })
                                        ...
                                        let bindyinhangka = cc.find("bigsublayer/bindyinhangka")
                                        hqq.setNode(bindyinhangka, { y: -10 })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: 198, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: 130, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: 60, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: -12, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: -82, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(bindyinhangka, { path: bpath + "4", zIndex: 0, x: 100, y: -150, width: 523, height: 64, type: cc.Sprite.Type.SLICED })
                                        ...
                                        hqq.addNode(bindyinhangka, { string: "yhkkh", zIndex: 0, x: -275, y: 198, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "skrxm", zIndex: 0, x: -275, y: 130, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "kfs", zIndex: 0, x: -300, y: 60, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "kfshi", zIndex: 0, x: -300, y: -12, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "khyh", zIndex: 0, x: -290, y: -82, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        hqq.addNode(bindyinhangka, { string: "khhzh", zIndex: 0, x: -275, y: -150, fontSize: 32, color: cc.color(232, 169, 98), bold: true })
                                        ...
                                        hqq.addNode(bindyinhangka, { string: "wxts2", zIndex: 0, fontSize: 23, lineHeight: 30, y: -210, color: cc.color(239, 216, 143) })
                                        this.ensurebtn.node.y = -280;
                        ...
                        case 3: // 注册正式账号
                                ...
                                if (hqq.app.pinpai == "fuxin") {
                                        ...
                                        hqq.addNode(officelogin, { path: bpath + "srk", zIndex: 0, width: 630, x: 30, y: 145, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "srk", zIndex: 0, width: 420, x: -75, y: 45, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "srk", zIndex: 0, width: 420, x: -75, y: -55, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "srk", zIndex: 0, width: 630, x: 30, y: -150, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "phone", zIndex: 0, x: -250, y: 145 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "aq", zIndex: 0, x: -250, y: 45 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "yj", zIndex: 0, x: -250, y: -55 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "lock", zIndex: 0, x: -250, y: -150 })
                                        ...
                                        let hpath = "juding/img/"
                                        let officelogin = cc.find("bigsublayer/officelogin")
                                        hqq.addNode(officelogin, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: 170, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: 60, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: -50, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: -160, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "shoujid", zIndex: 0, x: -250, y: 170 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "fang", zIndex: 0, x: -250, y: 60 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "duanxin", zIndex: 0, x: -250, y: -50 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "suotou", zIndex: 0, x: -250, y: -160 })

                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_lisp_line", zIndex: 0, width: 620, x: 30, y: 110 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_lisp_line", zIndex: 0, width: 620, x: 30, y: 0 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_lisp_line", zIndex: 0, width: 620, x: 30, y: -110 })

                                        cc.find("bigsublayer/officelogin/phoneeditbox").y = 170;
                                        cc.find("bigsublayer/officelogin/phoneeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/phoneeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/yanzheneditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/yanzheneditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/capchaeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/capchaeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/passeditbox/TEXT_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        cc.find("bigsublayer/officelogin/passeditbox/PLACEHOLDER_LABEL").getComponent(cc.Label).color = cc.color(84, 98, 119, 255);
                                        ...
                                        let hpath = "xinlong/img/"
                                        let officelogin = cc.find("bigsublayer/officelogin")
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: 170, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: 60, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 420, x: -75, y: -50, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "jd_p_inputBox_1", zIndex: 0, width: 630, x: 30, y: -160, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "shoujid", zIndex: 0, x: -250, y: 170 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "fang", zIndex: 0, x: -250, y: 60 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "duanxin", zIndex: 0, x: -250, y: -50 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "suotou", zIndex: 0, x: -250, y: -160 })
                                        ...
                                        let hpath = "huaxing/img/"
                                        let officelogin = cc.find("bigsublayer/officelogin")
                                        hqq.addNode(officelogin, { path: bpath + "4", zIndex: 0, width: 630, x: 30, y: 170, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "4", zIndex: 0, width: 420, x: -75, y: 60, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "4", zIndex: 0, width: 420, x: -75, y: -50, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "4", zIndex: 0, width: 630, x: 30, y: -160, type: cc.Sprite.Type.SLICED })
                                        hqq.addNode(officelogin, { path: bpath + "19", zIndex: 0, x: -250, y: 170 })
                                        hqq.addNode(officelogin, { path: bpath + "21", zIndex: 0, x: -250, y: 60 })
                                        hqq.addNode(officelogin, { Res: hqq["hall_" + hqq.app.pinpai], path: hpath + "20", zIndex: 0, x: -250, y: -50 })
                                        hqq.addNode(officelogin, { path: bpath + "18", zIndex: 0, x: -250, y: -160 })

                                        // // hqq.addNode(officelogin, { path: hpath + "jd_lisp_line", zIndex: 0, width:620 , x: 30, y: 110 })
                                        // // hqq.addNode(officelogin, { path: hpath + "jd_lisp_line", zIndex: 0, width:620 , x: 30, y: 0 })
                                        // // hqq.addNode(officelogin, { path: hpath + "jd_lisp_line", zIndex: 0, width:620 , x: 30, y: -110 })
                                        ...
                                        let hlpath2 = "language/" + hqq.language + "/ninetwo/"
                                        // // let officelogin = cc.find("bigsublayer/officelogin")
                                        // // hqq.addNode(officelogin, { path: bpath + "kuangti1", zIndex: 0, width: 750,height:350, x: 0, y: 0, type: cc.Sprite.Type.SLICED })
                                        // // let input1 = hqq.addNode(officelogin, { path: bpath + "yjks", zIndex: 0, width: 513*(750/576),height:36*(450/273), x: 0, y: 135, type: cc.Sprite.Type.SLICED })
                                        // // hqq.addNode(input1,{path:hpath + "shouji",x:-310})
                                        // // let input2 = hqq.addNode(officelogin, { path: bpath + "yjks", zIndex: 0, width: 290*(750/576), height: 36*(450/273),x:-145, y: 45, type: cc.Sprite.Type.SLICED })
                                        // // hqq.addNode(input2,{path:hpath + "34w",x:-167})
                                        // // let input3 = hqq.addNode(officelogin, { path: bpath + "yjks", zIndex: 0, width: 390*(750/576),height:36*(450/273), x: -82, y: -45, type: cc.Sprite.Type.SLICED })
                                        // // hqq.addNode(input3,{path:hpath + "twtrew",x:-226})
                                        // // let input4 = hqq.addNode(officelogin, { path: bpath + "yjks", zIndex: 0, width: 513*(750/576),height:36*(450/273), x: 0, y: -135, type: cc.Sprite.Type.SLICED })
                                        // // hqq.addNode(input4,{path:bpath + "gfdsg",x:-310})
        ...
        onClickKaihushengItem(event: any, custom: any) {
                ...
                if (hqq.app.pinpai === "juding" || hqq.app.pinpai === "xinlong") {
                        ...
                        templabel.getComponent(cc.Label).color = cc.color(255, 255, 255,255)
                }
                        ...
                        if (data.code == 200) {
                                ...
                                this.timer = setInterval(() => {
                                        ...
                                        if (time2 >= 60) {
                                                ...
                                                if (hqq.app.pinpai == "xingui") {
                                                        btnlabel.color = cc.color(255, 255, 255,255)
                                                        lao.color = cc.color(255, 255, 255,255)
                                                } else {
        ...
        officeloginEnsure() {
                ...
                if(!this.ensurebtn.interactable)return;
                this.ensurebtn.interactable = false
                ...
                let payUrl = hqq.app.server+ "/Game/User/SetGameUserPhone";
                let dataStr = "user_id=" + hqq.gameGlobal.pay.user_id;
        ...
        resetpassEnsure() {
                ...
                let callback = (data) => {
                        if (data.code == 200) {
                                ...
                                if (cc.isValid(this.ensurebtn)) {
                                this.ensurebtn.interactable = true;
                                if (data.code == 404) {
                                        this.panelInit(1)
                                        this.resetpass.getChildByName("phoneeditbox").getComponent(cc.EditBox).string = "";
                                        this.resetpass.getChildByName("yanzheneditbox").getComponent(cc.EditBox).string = "";
                                        this.resetpass.getChildByName("passeditbox").getComponent(cc.EditBox).string = "";
                                        hqq.eventMgr.dispatch(hqq.eventMgr.showTip, hqq.getTip("showtip108"))
                                }
                                }
