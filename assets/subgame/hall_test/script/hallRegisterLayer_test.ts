...
export class hallRegisterLayer_test extends cc.Component {
    ...
    onLoad() {
        ...
        this.goldlabel = cc.find("registerlayer/aninode/freegold").getComponent(cc.Label);
        this.chongzhi = cc.find("registerlayer/aninode/chongzhi").getComponent(cc.Label);
    }
    start() {
    }
    UILoad() {
