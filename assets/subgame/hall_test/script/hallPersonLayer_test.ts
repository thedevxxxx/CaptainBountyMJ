...
export class hallPersonLayer_test extends cc.Component {
    ...
    private hallversion:string = "1.0.7";
    getClassName() {
        return "hallPersonLayer_test";
    }
    onLoad() {
        this.txt_se = cc.find("personallayer/set/txt_se");
        this.txt_bgm = cc.find("personallayer/set/txt_bgm");
        this.phonebindbtn = cc.find("personallayer/person/phone_btn_bind");
        this.alipaybindbtn = cc.find("personallayer/person/alipay_btn_bind");
        this.yinhangkabindbtn = cc.find("personallayer/person/yinghangka_btn_bind");

        this.musictoggle = cc.find("personallayer/set/yinyuetoggle").getComponent(cc.Toggle);
        this.audiotoggle = cc.find("personallayer/set/yinxiaotoggle").getComponent(cc.Toggle);

        this.headimg = cc.find("personallayer/person/headfram3/masknode/head").getComponent(cc.Sprite);

        this.versionlabel = cc.find("personallayer/versionlabel").getComponent(cc.Label);
        this.goldlabel = cc.find("personallayer/person/personal_form2/gold").getComponent(cc.Label);
        this.nicklabel = cc.find("personallayer/person/personal_form/nick").getComponent(cc.Label);
        this.idlabel = cc.find("personallayer/person/personal_form/id").getComponent(cc.Label);
        this.phonelabel = cc.find("personallayer/person/personal_form/phone").getComponent(cc.Label);
        this.alipaylabel = cc.find("personallayer/person/personal_form/alipay").getComponent(cc.Label);
        this.yinghangkalabel = cc.find("personallayer/person/personal_form/yinhangka").getComponent(cc.Label);
    ...
    UILoad() {
        ...
        if (hqq.app.pinpai == "fuxin") {
            ...
            hqq.addNode(personal_form, { path: xpath + "srk", x: 55, y: 190, width: 250, zIndex: 0, type: cc.Sprite.Type.SLICED })
            hqq.addNode(personal_form, { path: xpath + "srk", x: 55, y: 100, width: 250, zIndex: 0, type: cc.Sprite.Type.SLICED })
            hqq.addNode(personal_form, { path: xpath + "srk", x: 55, y: 5, width: 250, zIndex: 0, type: cc.Sprite.Type.SLICED })
            hqq.addNode(personal_form, { path: xpath + "srk", x: 55, y: -90, width: 250, zIndex: 0, type: cc.Sprite.Type.SLICED })
            hqq.addNode(personal_form, { path: xpath + "srk", x: 80, y: -190, width: 300, zIndex: 0, type: cc.Sprite.Type.SLICED })
            ...
            // // cc.find("personallayer/person/personal_form/nick").color = cc.color(84,98,119,255);
            hqq.addNode(cc.find("personallayer/person/personal_form"), { path: xpath + "4", x: -10, y: 180, width: 230, height: 40, type: cc.Sprite.Type.SLICED, zIndex: 0 });
            hqq.addNode(cc.find("personallayer/person/personal_form"), { string: "grxxnick", x: -165, y: 168, color: cc.color(232, 169, 98), zIndex: 0, fontSize: 24, bold: true });
            this.nicklabel.node.setPositionEx(180, -120);
            // // cc.find("personallayer/person/personal_form/id").color = cc.color(84,98,119,255);
            hqq.addNode(cc.find("personallayer/person/personal_form"), { path: xpath + "4", x: -10, y: 90, width: 230, height: 40, type: cc.Sprite.Type.SLICED, zIndex: 0 });
            hqq.addNode(cc.find("personallayer/person/personal_form"), { string: "grxxid", x: -165, y: 78, color: cc.color(232, 169, 98), zIndex: 0, fontSize: 24, bold: true });
            this.idlabel.node.setPositionEx(90, -120);
            // // cc.find("personallayer/person/personal_form/phone").color = cc.color(84,98,119,255);
            hqq.addNode(cc.find("personallayer/person/personal_form"), { path: xpath + "4", x: -10, y: 0, width: 230, height: 40, type: cc.Sprite.Type.SLICED, zIndex: 0 });
            hqq.addNode(cc.find("personallayer/person/personal_form"), { string: "grxxphone", x: -165, y: -12, color: cc.color(232, 169, 98), zIndex: 0, fontSize: 24, bold: true });
            this.phonelabel.node.setPositionEx(0, -120);
            // // cc.find("personallayer/person/personal_form/alipay").color = cc.color(84,98,119,255);
            hqq.addNode(cc.find("personallayer/person/personal_form"), { path: xpath + "4", x: 5, y: -90, width: 265, height: 40, type: cc.Sprite.Type.SLICED, zIndex: 0 });
            hqq.addNode(cc.find("personallayer/person/personal_form"), { string: "grxxusdt", x: -195, y: -102, color: cc.color(232, 169, 98), zIndex: 0, fontSize: 24, bold: true });
            this.alipaylabel.node.setPositionEx(-120, this.alipaylabel.node.getPosition().y);
            // // cc.find("personallayer/person/personal_form/yinhangka").color = cc.color(84,98,119,255);
            hqq.addNode(cc.find("personallayer/person/personal_form"), { path: xpath + "4", x: 5, y: -175, width: 265, height: 40, type: cc.Sprite.Type.SLICED, zIndex: 0 });
            hqq.addNode(cc.find("personallayer/person/personal_form"), { string: "grxxyhk", x: -175, y: -187, color: cc.color(232, 169, 98), zIndex: 0, fontSize: 24, bold: true });
    ...
    init(data: any) {
        ...
        if (player.phonenum) {
            ...
            if (hqq.app.pinpai != "xinlong") {
                this.phonelabel.color = cc.color(225, 225, 225,255)
            }
        ...
        // //     this.alipaylabel.node.color = cc.color(225, 225, 225,255)
        ...
        if (player.usdtaddr) {
            ...
            if (hqq.app.pinpai != "xinlong") {
                this.alipaylabel.color = cc.color(225, 225, 225,255)
            }
            this.alipaybindbtn.active = false
        ...
        if (player.yinhangka) {
            ...
            if (hqq.app.pinpai != "xinlong") {
                this.yinghangkalabel.color = cc.color(225, 225, 225,255)
            }
            this.yinhangkabindbtn.active = false
        }
        hqq.audioMgr && hqq.audioMgr.bgIsOpen ? this.musictoggle.setIsCheckedWithoutNotify(true) : this.musictoggle.setIsCheckedWithoutNotify(false)
        hqq.audioMgr && hqq.audioMgr.effectIsOpen ? this.audiotoggle.setIsCheckedWithoutNotify(true) : this.audiotoggle.setIsCheckedWithoutNotify(false);
    ...
    onClicktxt_se() {
        ...
        if (this.num0 > 15 && this.num1 > 15) {
            ...
            str += "\n基础包版号:" + hqq.app.hallVersion;
            str += "\n大厅版号:" + this.hallversion;
            this.versionlabel.string = str
        }
    }
    onClicktxt_bgm() {
