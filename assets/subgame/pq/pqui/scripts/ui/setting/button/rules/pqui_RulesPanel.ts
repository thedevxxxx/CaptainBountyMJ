...
export default class pqui_RulesPanel {

    public rulesPanelBackgroundNode: Node;
    ...
    public constructor(parent: Node, pqui_UIFactory: pqui_UIFactory, onDestroy: Function) {
        ...
        const rulesPanelBackgroundNode = panel.backgroundNode;
        this.rulesPanelBackgroundNode = rulesPanelBackgroundNode;

        const titleLabel = pqui_UIFactory.createLabel({
            parent: rulesPanelBackgroundNode,
            name: "title"
        }, {
            string: "游戏规则",
