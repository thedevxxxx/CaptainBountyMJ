...
import { ClipPart } from "./mjhl_Audio";

export default class mjhl_AudioPlayer {
    ...
    public playByClipPart(clipPart: ClipPart, onCompletedOnce?: Function) {
        ...
        audioSource.play();
        //console.log(`[mjhl_AudioPlayer] playByClipPart ${clipPart.name},audioSource.duration: ${audioSource.duration},audioSource.clip.getDuration(): ${audioSource.clip.getDuration()}, clipPart.startTime: ${clipPart.startTime}, audioSource.currentTime ${audioSource.currentTime}, isLoop: ${isLoop}`);
