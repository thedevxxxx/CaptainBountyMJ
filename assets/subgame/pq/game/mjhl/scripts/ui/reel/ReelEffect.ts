...
export default class ReelEffect {
    ...
    public async init(reelEffectParameter: ReelEffectParameter) {
        const mjhl_UIFactory = reelEffectParameter.mjhl_UIFactory;
        ...
        const particleMiddleNode = hqq.addNode(rootNode,{
            Res:hqq['pq'],
            skeleton:"game/mjhl/animations/spines/fast_vfx_b/",
            name:"particleMiddle"
        }); 
        ...
        const particleRightNode = hqq.addNode(rootNode,{
            Res:hqq['pq'],
            skeleton:"game/mjhl/animations/spines/fast_vfx_c/",
            name:"particleRight",
        ...
        const lightEffectRightNode = hqq.addNode(rootNode,{
            Res:hqq['pq'],
            skeleton:"game/mjhl/animations/spines/fast_vfx_a/",
