...
export default class mahjongWays2_Receiver extends ReceiverBase {
    constructor(cfg: mahjongWays2_Config, locator: pqui_ServiceLocator, dataRepo: mahjongWays2_DataRepository) {
