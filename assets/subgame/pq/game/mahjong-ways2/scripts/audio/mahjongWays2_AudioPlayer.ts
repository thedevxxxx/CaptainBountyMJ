...
import { ClipPart } from "./mahjongWays2_Audio";

export default class mahjongWays2_AudioPlayer {
    ...
    public playByClipPart(clipPart: ClipPart, onCompletedOnce?: Function) {
        ...
        audioSource.play();
        //console.log(`[mahjongWays2_AudioPlayer] playByClipPart ${clipPart.name},audioSource.duration: ${audioSource.duration},audioSource.clip.getDuration(): ${audioSource.clip.getDuration()}, clipPart.startTime: ${clipPart.startTime}, audioSource.currentTime ${audioSource.currentTime}, isLoop: ${isLoop}`);
