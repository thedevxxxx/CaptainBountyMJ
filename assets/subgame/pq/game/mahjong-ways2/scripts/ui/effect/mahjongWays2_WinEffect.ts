...
export default class mahjongWays2_WinEffect {
    ...
    public async init(mahjongWays2_WinEffectParameter: mahjongWays2_WinEffectParameter) {
        await this.createUI(mahjongWays2_WinEffectParameter);
    ...
    private async createUI(mahjongWays2_WinEffectParameter: mahjongWays2_WinEffectParameter) {
        const parent = mahjongWays2_WinEffectParameter.parent;
        const mahjongWays2_UIFactory = mahjongWays2_WinEffectParameter.mahjongWays2_UIFactory;
        const mahjongWays2_EventRepository = mahjongWays2_WinEffectParameter.mahjongWays2_EventRepository;

        this.mahjongWays2_UIFactory = mahjongWays2_UIFactory;

        const rootNode = mahjongWays2_UIFactory.createNode({
            parent: parent,
            name: "mahjongWays2_WinEffect",
            position: new Vec3(0, 100)
        });
        this.rootNode = rootNode;

        const background = mahjongWays2_UIFactory.createButton({
            parent: rootNode,
            name: "background"
        }, {
            ...
            spriteFramePath: "mahjong-ways2/images/mahjongWays2_white/spriteFrame",
            ...
            left: 0,
            right: 0,
            target: mahjongWays2_UIFactory.canvasNode
        });
        ...
        const coinsFountainParticle = await this.mahjongWays2_UIFactory.createParticleSystem2DAsync({
            ...
            filePath: "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b",
            spriteFramePaths: [
        ...
        const ingotsFountainParticle = await this.mahjongWays2_UIFactory.createParticleSystem2DAsync({
            nodeParameter: {
                parent: rootNode,
            ...
            filePath: "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b",
            spriteFramePaths: [
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_00/spriteFrame",
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_01/spriteFrame",
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_02/spriteFrame",
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_03/spriteFrame",
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_04/spriteFrame",
                "mahjong-ways2/images/effects/particles/bw_particle/bw_particle_b_05/spriteFrame"
            ]
        });
        ...
        const rainParticle = await this.mahjongWays2_UIFactory.createParticleSystem2DAsync({
            ...
            playOnLoad: true,
            autoRemoveOnFinish: false,
            filePath: "mahjong-ways2/images/effects/particles/rainParticle/bw_particle_c",
            spriteFramePaths: [
                "mahjong-ways2/images/effects/particles/rainParticle/bw_particle_c_01/spriteFrame",
                "mahjong-ways2/images/effects/particles/rainParticle/bw_particle_c_02/spriteFrame",
                "mahjong-ways2/images/effects/particles/rainParticle/bw_particle_c_03/spriteFrame",
            ],
            customMaterialPath: "mahjong-ways2/materials/remove-black-material"
        });

        const plate = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "plate",
            scale: new Vec3(1, 1)
        }, {
            ...
            spriteFramePath: "mahjong-ways2/images/effects/bigWinEffect/bw_vfx_a/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        this.plate = plate;

        const backTreasureBowlContainer = mahjongWays2_UIFactory.createNode({
            parent: rootNode,
            name: "backTreasureBowlContainer"
        });
        this.backTreasureBowlContainer = backTreasureBowlContainer;
        const backLeftTreasureBowl = mahjongWays2_UIFactory.createSprite({
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_treasureBowl/spriteFrame"
        });
        const backRightTreasureBowl = mahjongWays2_UIFactory.createSprite({
            parent: backTreasureBowlContainer,
            name: "backLeftTreasureBowl",
            scale: new Vec3(-1, 1)
        }, {
        ...
        const bigWinBackground = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_bigWin/spriteFrame"
        });
        this.bigWinBackground = bigWinBackground;

        const frontTreasureBowlContainer = mahjongWays2_UIFactory.createNode({
            position: new Vec3(0, -150),
            parent: rootNode,
            name: "fontTreasureBowlContainer"
        });
        this.frontTreasureBowlContainer = frontTreasureBowlContainer;
        const frontLeftTreasureBowl = mahjongWays2_UIFactory.createSprite({
        ...
        const frontRightTreasureBowl = mahjongWays2_UIFactory.createSprite({
            parent: frontTreasureBowlContainer,
            name: "backLeftTreasureBowl",
            scale: new Vec3(-1, 1)
        }, {
        ...
        const treasureTowerContainer = mahjongWays2_UIFactory.createNode({
            position: new Vec3(0, -150),
            parent: rootNode,
            name: "treasureTowerContainer"
        });
        this.treasureTowerContainer = treasureTowerContainer;
        const leftTreasureTower = mahjongWays2_UIFactory.createSprite({
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_treasureTower/spriteFrame"
        });
        const rightTreasureTower = mahjongWays2_UIFactory.createSprite({
            parent: treasureTowerContainer,
        ...
        const glare = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "glare",
            ...
            spriteFramePath: "mahjong-ways2/images/effects/bigWinEffect/bw_vfx_b/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        this.glare = glare;

        const halo = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "halo",
            scale: new Vec3(5, 5)
        }, {
            ...
            spriteFramePath: "mahjong-ways2/images/effects/bigWinEffect/bw_vfx_g/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        this.halo = halo;


        const sunLight = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "plate",
            scale: new Vec3(1.5, 1.5)
        }, {
            ...
            spriteFramePath: "mahjong-ways2/images/effects/bigWinEffect/bw_vfx_c/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        const explosion = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "plate",
            scale: new Vec3(2, 2)
        }, {
            ...
            spriteFramePath: "mahjong-ways2/images/effects/bigWinEffect/bw_vfx_f/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        ...
        const textContainer = mahjongWays2_UIFactory.createNode({
            position: new Vec3(0, -50),
            parent: rootNode,
            name: "textContainer"
        });
        this.textContainer = textContainer;
        const bigWinSprite = mahjongWays2_UIFactory.createSprite({
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_txt_bigWin/spriteFrame"
        });
        this.bigWinSprite = bigWinSprite;
        const megaWinSprite = mahjongWays2_UIFactory.createSprite({
            parent: textContainer,
            name: "megaWin",
        }, {
            type: Sprite.Type.SIMPLE,
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_txt_megaWin/spriteFrame"
        });
        this.megaWinSprite = megaWinSprite;
        const superWinSprite = mahjongWays2_UIFactory.createSprite({
            parent: textContainer,
            name: "superWin",
        }, {
            type: Sprite.Type.SIMPLE,
            ...
            spriteFramePath: "mahjong-ways2/images/win/mahjongWays2_txt_superWin/spriteFrame"
        });
        ...
        const spriteNumberDisplayer = new mahjongWays2_SpriteNumberDisplayer({
            ...
            //onStartTweenToNumber: () => mahjongWays2_EventRepository.onWinEffectTweenToNumberStarted.Notify(),
            //onTweenToNumberFinished: () => mahjongWays2_EventRepository.onWinEffectTweenToNumberFinished.Notify()
        });
...
interface mahjongWays2_WinEffectParameter {
    parent: Node;
    mahjongWays2_UIFactory: mahjongWays2_UIFactory;
