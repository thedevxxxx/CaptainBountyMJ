...
import mahjongWays2_UIFactory,{WidgetParameter} from "../../../../../script/ui/pq_UIFactory";

export default class mahjongWays2_SpriteNumberDisplayer {
    ...
    public constructor(spriteNumberDisplayerParameter: SpriteNumberDisplayerParameter) {
        ...
        const mahjongWays2_UIFactory = spriteNumberDisplayerParameter.mahjongWays2_UIFactory;
        ...
        mahjongWays2_UIFactory.addWidget(layoutNode, spriteNumberDisplayerParameter.widgetParameter);
    ...
    public async startTweenToNumber(tweenToNumberParameter: TweenToNumberParameter) {
        return new Promise<void>(resolve => {
            ...
            console.log(`[mahjongWays2_FreeGameSettlePanel] mahjongWays2_SpriteNumberDisplayer ${endValue}`);
    ...
    public async setSpriteNumber(number: number) {
        ...
        for (let index = 0; index < spriteFrameNames.length; index++) {
            ...
            sprite.spriteFrame = await this.mahjongWays2_UIFactory.assetRepository.getAsset<SpriteFrame>(`mahjong-ways2/images/freegame/num/mahjongWays2_num_gold_guang_${spriteFrameName}/spriteFrame`, SpriteFrame);
        }
    }
