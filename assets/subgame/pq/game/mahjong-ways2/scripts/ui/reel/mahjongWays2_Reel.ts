// // import mahjongWays2_Symbol, { FallParameter, FlipParamter, SpinParameter, SymbolState } from "../symbol/mahjongWays2_Symbol";
// import { ReelResult, SymbolName, SymbolResult } from "../../type/mahjongWays2_Types";
// import { Node, SpriteFrame } from "cc";
// import mahjongWays2_SymbolGuider from "../symbol/mahjongWays2_SymbolGuider";
// import { isScatter } from "../../predictor/mahjongWays2_Predictor";
...
// export default class mahjongWays2_Reel {
...
//     private symbols: Array<mahjongWays2_Symbol>;
...
//         const mahjongWays2_SymbolGuider = reelParameter.mahjongWays2_SymbolGuider;
//         const mahjongWays2_UIFactory = reelParameter.mahjongWays2_UIFactory;
//         const mahjongWays2_EventRepository = reelParameter.mahjongWays2_EventRepository;
...
//             parent: parent,
//             name: "mahjongWays2_Reel"
//         });
//         this.symbols = new Array<mahjongWays2_Symbol>();
//         for (let index = 0; index < this.symbolCountPerReel; index++) {
//             const symbol = await new mahjongWays2_Symbol().init({
//                 parent: node,
//                 reelIndex: reelIndex,
...
//             this.symbols = null;
//         } catch (error) {
//             console.log(`[mahjongWays2_Reel] ${error}`);
//         }
//     }
...
//         this.mahjongWays2_EventRepository.onReelSpinFinished.Notify(reelResult);
//         this.orderSymbolsBySymbolSiblingIndex();//??
//         this.setSymbolsSiblingIndexByCurrentOrder();
...
//         this.setSymbolsSiblingIndexByCurrentOrder();
//         if (hasScatterFall) {
//             this.mahjongWays2_EventRepository.onScatterFall.Notify();
//         }
//     }
