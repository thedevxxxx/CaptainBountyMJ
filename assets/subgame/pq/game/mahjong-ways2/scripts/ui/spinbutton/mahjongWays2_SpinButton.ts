...
import mahjongWays2_GameState, { GameState } from "../gamestate/mahjongWays2_GameState";
...
export default class mahjongWays2_SpinButton {
    ...
    public async init(spinButtonParameter: SpinButtonParameter) {
        ...
        const mahjongWays2_UIFactory = spinButtonParameter.mahjongWays2_UIFactory;
        const mahjongWays2_EventRepository = spinButtonParameter.mahjongWays2_EventRepository;
        const mahjongWays2_GameState = spinButtonParameter.mahjongWays2_GameState;
        ...
        mahjongWays2_EventRepository.onAutoSpin.Attach((count) => {
    ...
    public destroy() {
        try {
            ...
            console.log(`[mahjongWays2_SpinButton] ${error}`);
        }
    }
    ...
    private async createUI(parent: Node, mahjongWays2_UIFactory: mahjongWays2_UIFactory) {
        const rootNode = mahjongWays2_UIFactory.createNode({
            parent: parent,
            name: "mahjongWays2_SpinButton",
            position: new Vec3(0, -10, 0)
        });

        const haloSprite = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "haloSprite",
            scale: new Vec3(2, 2),
            ...
            spriteFramePath: "mahjong-ways2/images/effects/spinGlow/spin_glow_a/spriteFrame",
        ...
        const button = mahjongWays2_UIFactory.createButton({
            ...
            sizeMode: Sprite.SizeMode.CUSTOM,
            type: Sprite.Type.SIMPLE,
            spriteFramePath: "mahjong-ways2/images/ui/mj_btn_circle/mahjongWays2_btn_circle_01/spriteFrame"
        });
        const buttonNode = button.node;
        this.buttonNode = buttonNode;
        const turntableSprite = mahjongWays2_UIFactory.createSprite({
            parent: button.node,
            name: "",
            ...
            sizeMode: Sprite.SizeMode.CUSTOM,
            type: Sprite.Type.SIMPLE,
            spriteFramePath: "mahjong-ways2/images/ui/mj_btn_circle/mahjongWays2_btn_circle_rotate_yellow/spriteFrame"
        });
        this.turntableSprite = turntableSprite;
        const turntableNode = turntableSprite.node;
        this.turntableNode = turntableNode;

        const autoNode = mahjongWays2_UIFactory.createNode({
            parent: rootNode,
            name: ""
        });
        autoNode.active = false;
        this.autoNode = autoNode;
        const autoSpinButton = mahjongWays2_UIFactory.createButton({
            parent: autoNode,
            name: ""
        }, {
            transition: Button.Transition.NONE,
            ...
            sizeMode: Sprite.SizeMode.CUSTOM,
            type: Sprite.Type.SIMPLE,
            spriteFramePath: "mahjong-ways2/images/ui/mj_btn_circle/mahjongWays2_btn_circle_02/spriteFrame"
        });

        const autoCountLabel = mahjongWays2_UIFactory.createLabel({
            parent: autoNode,
            name: "totalWinLabel"
        }, {
        ...
        const auraSprite = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "auraSprite",
            scale: new Vec3(2, 2),
            ...
            sizeMode: Sprite.SizeMode.CUSTOM,
            type: Sprite.Type.SIMPLE,
            spriteFramePath: "mahjong-ways2/images/effects/spinGlow/spin_glow_d/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
        ...
        const particleSkeletonNode = hqq.addNode(rootNode,{
            Res:hqq['pq'],
            skeleton:"game/mahjong-ways2/animations/spines/spin_vfx_a/",
        ...
        const reflectionSkeletonNode = hqq.addNode(rootNode,{
            Res:hqq['pq'],
            skeleton:"game/mahjong-ways2/animations/spines/spin_vfx_b/",
        ...
        const lightSprite = mahjongWays2_UIFactory.createSprite({
            parent: rootNode,
            name: "lightSprite",
            ...
            sizeMode: Sprite.SizeMode.CUSTOM,
            type: Sprite.Type.SIMPLE,
            spriteFramePath: "mahjong-ways2/images/effects/spinGlow/spin_flare_a/spriteFrame",
            materialPath: "mahjong-ways2/materials/remove-black-material"
        });
    ...
    private onButtonClicked() {
        if (this.getCanSpin()) {
            this.mahjongWays2_EventRepository.onSpinButtonClicked.Notify();
            mjhlNetMgr.sendSpin();
    ...
    private async setTurntableSkin(isClickable: boolean, isHighSpeed: boolean) {
        let spriteFrameName = (isClickable) ? "mahjongWays2_btn_circle_rotate_yellow" : "mahjongWays2_btn_circle_rotate_gray";
        spriteFrameName = (isHighSpeed) ? `${spriteFrameName}_blur` : spriteFrameName;
        const spriteFramePath = `mahjong-ways2/images/ui/mj_btn_circle/${spriteFrameName}/spriteFrame`;
        this.turntableSprite.spriteFrame = await this.mahjongWays2_UIFactory.assetRepository.getAsset<SpriteFrame>(spriteFramePath, SpriteFrame);
    }

    private getCanSpin(): boolean {
        return this.mahjongWays2_GameState.gameStateMachine.isState(GameState.Idle);
    }
    ...
    private checkAutoSpin() {
        if (this.autoSpinCount > 0) {
            ...
            this.mahjongWays2_EventRepository.onAutoSpinOnce.Notify();
    ...
    private stopAutoSpin() {
        ...
        this.mahjongWays2_EventRepository.onStopAutoSpin.Notify();
    }
