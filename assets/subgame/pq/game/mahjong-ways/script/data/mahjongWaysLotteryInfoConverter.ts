...
import { isGoldenMahjong, isScatter } from "../predictor/mahjongWaysPredictor";
import { ReelResult, RoundResult, SymbolName, SymbolResult } from "../network/mahjongWaysModel";
import { mahjongWaysNetManager as netMgr ,mahjongWaysEventType} from '../network/mahjongWaysNetManager';

import { log } from "cc";

export default class mahjongWaysLotteryInfoConverter {
    static previousFinalFreeCount: number;

    // static instance: mahjongWaysLotteryInfoConverter;
    // static get inst(): mahjongWaysLotteryInfoConverter {
    //     if (!this.instance) {
    //         this.instance = new mahjongWaysLotteryInfoConverter();
    //     }
