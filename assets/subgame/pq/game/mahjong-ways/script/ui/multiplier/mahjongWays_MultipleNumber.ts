...
@ccclass('mahjongWays_MultipleNumber')
export default class mahjongWays_MultipleNumber extends Component{
    ...
    private initUI() {
        console.log("initUI_mahjongWays_MultipleNumber");
        this.backgroundNode = this.node.getChildByName("mahjongWays_multiplier_vfx_a_screen");
    ...
    public switchAll(flag:boolean) {
        console.log("switchAll_mahjongWays_MultipleNumber");
    ...
    public switchText(flag: boolean,particleFlag:boolean,onNumAnim:boolean) {
        this.backgroundNode.active = flag;
        this.onNum.active = flag;
