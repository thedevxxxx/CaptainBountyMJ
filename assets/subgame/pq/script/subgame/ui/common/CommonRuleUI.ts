...
import { _decorator, Component, Node, Sprite, UITransform, Layers, ScrollView, Vec3 } from 'cc';
import { PQAsset } from '../../../asset/PQAssetRepository';
import { commonEvent, EventType } from '../../../event/CommonEventManage';
const { ccclass, property } = _decorator;
 
@ccclass('CommonRuleUI')
export class CommonRuleUI extends Component {
    ...
    private addEvent() {
        commonEvent.register(EventType.RULE_UI_OPEN, this, this.open.bind(this));
        commonEvent.register(EventType.RULE_UI_CLOSE, this, this.close.bind(this));
    }

    private removeEvent() {
        commonEvent.unregister(EventType.RULE_UI_OPEN, this);
        commonEvent.unregister(EventType.RULE_UI_CLOSE, this);
    }
