...
function _replaceIcons() {
    ...
    copyFile(m_projectPath + m_pathTag + "extensions" + m_pathTag + "hqq" + m_pathTag + "icon" + m_pathTag + m_pinpai + "" + m_pathTag + "mipmap-mdpi" + m_pathTag + "ic_launcher.png", m_projectPath + m_pathTag + "native" + m_pathTag + "engine" + m_pathTag + "android" + m_pathTag + "res" + m_pathTag + "mipmap-mdpi" + m_pathTag + "ic_launcher.png");
    copyFile(m_projectPath + m_pathTag + "extensions" + m_pathTag + "hqq" + m_pathTag + "icon" + m_pathTag + m_pinpai + "" + m_pathTag + "mipmap-xhdpi" + m_pathTag + "ic_launcher.png", m_projectPath + m_pathTag + "native" + m_pathTag + "engine" + m_pathTag + "android" + m_pathTag + "res" + m_pathTag + "mipmap-xhdpi" + m_pathTag + "ic_launcher.png");
    copyFile(m_projectPath + m_pathTag + "extensions" + m_pathTag + "hqq" + m_pathTag + "icon" + m_pathTag + m_pinpai + "" + m_pathTag + "mipmap-xxhdpi" + m_pathTag + "ic_launcher.png", m_projectPath + m_pathTag + "native" + m_pathTag + "engine" + m_pathTag + "android" + m_pathTag + "res" + m_pathTag + "mipmap-xxhdpi" + m_pathTag + "ic_launcher.png");
    copyFile(m_projectPath + m_pathTag + "extensions" + m_pathTag + "hqq" + m_pathTag + "icon" + m_pathTag + m_pinpai + "" + m_pathTag + "mipmap-ldpi" + m_pathTag + "ic_launcher.png", m_projectPath + m_pathTag + "native" + m_pathTag + "engine" + m_pathTag + "android" + m_pathTag + "res" + m_pathTag + "mipmap-ldpi" + m_pathTag + "ic_launcher.png");
    copyFile(m_projectPath + m_pathTag + "extensions" + m_pathTag + "hqq" + m_pathTag + "icon" + m_pathTag + m_pinpai + "" + m_pathTag + "mipmap-xxxhdpi" + m_pathTag + "ic_launcher.png", m_projectPath + m_pathTag + "native" + m_pathTag + "engine" + m_pathTag + "android" + m_pathTag + "res" + m_pathTag + "mipmap-xxxhdpi" + m_pathTag + "ic_launcher.png");
 ...
 */
function _changePackageInfoInJava(options, result) {
